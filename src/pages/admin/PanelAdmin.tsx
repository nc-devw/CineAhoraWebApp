...
export const PanelAdmin: React.FC = () => {
  ...
  return (
    <div className="mt-5 ml-5">
      ...
      <div className="flex flex-wrap mt-6">
        <div className="w-full">
          <h2 className="text-xl text-[#4F46E5]">3. Seleccionar horarios de función</h2>
          {/* Days */}
      ...
      <div className="flex flex-wrap mt-6">
        <div className="w-full">
          <h2 className="text-xl text-[#4F46E5]">4. Vigencia de la programación</h2>
